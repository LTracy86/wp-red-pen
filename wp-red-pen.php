...
function wprp_render_repo_page() {
	...
	if ( $wprp_dark ) {
		...
		echo '<style id="wprp-repo-dark">.wrap.wprp-dark{background:#1e2125;color:#e6e9ec;padding:10px 16px 24px;border-radius:6px;margin-top:10px}.wrap.wprp-dark h1,.wrap.wprp-dark h2,.wrap.wprp-dark h3,.wrap.wprp-dark strong{color:#e6e9ec}.wrap.wprp-dark a{color:#6db3ff}.wrap.wprp-dark p,.wrap.wprp-dark label,.wrap.wprp-dark .subsubsub,.wrap.wprp-dark .subsubsub a{color:#b9c0c7}.wrap.wprp-dark .subsubsub a.current{color:#fff;font-weight:600}.wrap.wprp-dark .wp-list-table{background:#23272b;border-color:#3a3f44}.wrap.wprp-dark .wp-list-table th,.wrap.wprp-dark .wp-list-table td{color:#e6e9ec;border-color:#3a3f44;background:transparent}.wrap.wprp-dark .wp-list-table thead th,.wrap.wprp-dark .wp-list-table tfoot th{background:#2a2f34;color:#aeb4ba}.wrap.wprp-dark .wp-list-table.striped>tbody>:nth-child(odd){background:#262b30}.wrap.wprp-dark details{background:#23272b;border:1px solid #3a3f44;color:#e6e9ec}.wrap.wprp-dark input,.wrap.wprp-dark select,.wrap.wprp-dark textarea{background:#1a1d20;color:#e6e9ec;border-color:#3a3f44}.wrap.wprp-dark .button:not(.button-primary){background:#2a2f34;color:#e6e9ec;border-color:#4a4f55;box-shadow:none}.wrap.wprp-dark .button:not(.button-primary):hover{background:#333941;color:#fff;border-color:#5a616a}.wrap.wprp-dark .notice{background:#23272b;color:#e6e9ec;border-color:#3a3f44}.wrap.wprp-dark code{background:#15181b;color:#e6e9ec}</style>';
	}

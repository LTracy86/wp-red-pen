...
function wprp_print_frontend_assets() {
	...
	<style id="wprp-css">
		...
		#wprp-capture .wprp-hint,#wprp-pinmode .wprp-hint{position:fixed;top:14px;left:50%;transform:translateX(-50%);background:var(--wprp-ink);color:#fff;font-family:-apple-system,sans-serif;font-size:.82rem;padding:.4rem .8rem;border-radius:6px;pointer-events:none}
			...
			#wprp-markup .wprp-mk-bar{display:flex;gap:6px;align-items:center;background:var(--wprp-ink);padding:6px;border-radius:8px;font-family:-apple-system,sans-serif;flex-wrap:wrap;justify-content:center}
			#wprp-markup .wprp-mk-tool{background:#3A3A3C;border:1px solid #55585b;color:#fff;font:inherit;font-size:.8rem;padding:.32rem .6rem;border-radius:5px;cursor:pointer;line-height:1}
			#wprp-markup .wprp-mk-tool:hover{border-color:var(--wprp-red)}
			#wprp-markup .wprp-mk-tool.is-active{background:var(--wprp-red);border-color:var(--wprp-red)}
			#wprp-markup .wprp-mk-sp{width:1px;height:20px;background:#55585b;margin:0 2px}
			#wprp-markup .wprp-mk-done{background:var(--wprp-red);border-color:var(--wprp-red);font-weight:700}
